...
describe("Ollama usage", () => {
  ...
  it("captures exact input, output, optional cached tokens, and provider durations", () => expect(parseOllamaUsage({ prompt_eval_count: 100, eval_count: 25, prompt_eval_cached_count: 40, total_duration: 12_400_000, eval_duration: 8_600_000 })).toEqual({ inputTokens: 100, outputTokens: 25, cachedTokens: 40, reasoningTokens: null, providerDurationMs: 12, generationDurationMs: 9 }));
